        ...
        <section class="mt-32">
            <div class="grid grid-cols-12 w-full gap-20">
                <div class="col-span-6">
                    <h6 class="mb-6 text-xl font-medium text-center">Top 10 sách bán chạy nhất</h6>
                    <a-table :columns="tableBestSellerColumns" :dataSource="bookBestSeller ?? []" rowKey="id"
...
const { data: bookBestSeller } = await useFetch<any[]>('/api/statistics/top-10-best-seller', {
    method: 'GET',
    headers: {
