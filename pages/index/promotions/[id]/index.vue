<template>
    <div class="px-10 py-10">
        ...
        <div  v-if="promotion" class="flex flex-nowrap gap-10">
            ...
            <div class="w-1/2">
                <h6 class="mb-6 font-semibold">Sách áp dụng khuyến mãi:</h6>
                <div v-if="promotion?.books?.length" class="border p-4 max-h-[70vh] overflow-y-scroll">
                    <div v-for="book in promotion.books" :key="book.id" class="flex w-full gap-4 my-2">
                        <div class="w-full">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500">Giá bán: {{ formatCurrency(book.price * (100 -
                ...
                <div v-else class="border p-4">
                    <a-empty description="Chưa có sách nào được áp dụng"></a-empty>
                </div>
            </div>
        </div>
    </div>
