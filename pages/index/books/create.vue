<template>
  <div class="px-6 py-10">
    ...
    <h3 class="font-bold text-2xl mb-6">Thêm mới sách</h3>
    <a-form :model="formCreate" :rules="rules" ref="formRef" layout="vertical" @finish="handleCreate">
      ...
      <a-form-item label="ISBN" name="ISBN" required>
        <a-input v-model:value="formCreate.ISBN" />
      </a-form-item>
      ...
      <a-form-item label="Nhà xuất bản" name="publisher_id" required>
        <a-select v-model:value="formCreate.publisher_id" placeholder="Chọn nhà xuất bản">
      ...
      <a-form-item label="Tác giả" name="authors" required>
        <a-select v-model:value="formCreate.authors" mode="multiple" placeholder="Chọn tác giả">
